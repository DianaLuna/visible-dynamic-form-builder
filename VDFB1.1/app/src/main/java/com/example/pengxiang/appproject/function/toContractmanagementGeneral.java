...
public class toContractmanagementGeneral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.contractmanagement_general);
...
//        listview.setAdapter(arr_adapter);
        ...
        simp_adapter = new SimpleAdapter(toContractmanagementGeneral.this, getDataList(), R.layout.contractitem, new String[]{"item","text"}, new int[]{R.id.textView1, R.id.textView2});
